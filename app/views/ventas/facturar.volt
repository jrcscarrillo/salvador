                    ...
                    <tbody>
                        ...
                        {% endfor %}
                            ...
                            <tr>
                                ...
                                <td class="totals" colspan="3">Subtotal 12% :</td>
                                <td class="totals" align="right">

                                    {{ invoice.getSubtotal() | number_format(2, ',', '.') }} </td>
                            </tr>
                            <tr>
                                <td class="totals" colspan="3">Subtotal 0% :</td>
                                <td class="totals" align="right">0.00</td>
                            </tr>
                            <tr>
                                <td class="totals" colspan="3">Sin Impuestos :</td>
                                <td class="totals" align="right">0.00</td>
                            </tr>
                            <tr>
                                <td class="totals" colspan="3"><b>IVA 12% :</b></td>
                                <td class="totals" align="right"><b>

                                        {{ invoice.getSalesTaxTotal() | number_format(2, ',', '.') }} </b></td>
                            </tr>
                            <tr>
                                <td class="totals" colspan="3">Descuentos :</td>
                                <td class="totals" align="right">0.00</td>
                            </tr>
                            <tr>
                                <td class="totals" colspan="3"><b>Importe Total:</b></td>
                                <td class="totals" align="right"><b>
