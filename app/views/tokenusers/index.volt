<div class="page-header">
    ...
    <p>
        {{ link_to("tokenusers/new", "Create tokenusers") }}
    </p>
</div>

{{ content() }}

{{ form("tokenusers/search", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}

<div class="form-group">
    <label for="fieldListid" class="col-sm-2 control-label">ListID</label>
    <div class="col-sm-10">
        {{ text_field("ListID", "type" : "numeric", "class" : "form-control", "id" : "fieldListid") }}
    </div>
</div>
